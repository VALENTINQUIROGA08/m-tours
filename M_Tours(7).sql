...
--
-- Servidor: localhost
-- Tiempo de generación: 10-11-2025 a las 19:56:22
...
INSERT INTO `pago` (`id_pago`, `metodo_pago`, `fecha`, `precio`) VALUES
(1, 'Tarjeta de crédito', '2025-08-01', '55.75'),
(2, 'PayPal', '2025-08-02', '30.50'),
(3, 'Transferencia bancaria', '2025-08-03', '120.00'),
(4, 'Tarjeta de débito', '2025-08-04', '15.20'),
(5, 'Tarjeta de crédito', '2025-08-05', '85.99'),
(6, 'PayPal', '2025-08-06', '22.10'),
(7, 'Transferencia bancaria', '2025-08-07', '200.00'),
(8, 'Tarjeta de débito', '2025-08-08', '45.60'),
(9, 'Tarjeta de crédito', '2025-08-09', '75.30'),
(10, 'PayPal', '2025-08-10', '90.00');
...
INSERT INTO `Usuarios` (`id_usuario`, `nombre`, `email`, `telefono`, `edad`, `contraseña`) VALUES
(1, 'elio', 'dvbhuaisdhvu@gmail.com', '1234354566', 234, '0'),
(2, 'mati', 'adfvghdasivghds@gmail.com', '1231211233', 4, '0'),
(3, 'Ana García', 'ana.garcia@email.com', '555-123-4567', 30, '0'),
(4, 'Juan Pérez', 'juan.perez@email.com', '555-987-6543', 25, '0'),
(5, 'María López', 'maria.lopez@email.com', '555-111-2222', 42, '0'),
(6, 'Carlos Ruiz', 'carlos.ruiz@email.com', '555-333-4444', 35, '0');
